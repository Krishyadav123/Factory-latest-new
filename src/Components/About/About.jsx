      ...
      <div className="about-main">
        <div className="about-main-img">
          ...
          <div className="images mid-img">
            <img
              src={`https://res.cloudinary.com/dcsentl2f/image/upload/w_400,h_300,c_scale,q_auto,f_auto/v1731404899/shreeInsul/intro%20of%20us%20image/ou1evizsnoiclntykhsr.jpg`}
              alt=""
            />
          </div>
        ...
        <div className="about-main-img-container">
          <div className="about-main-img-container-1">
            ...
            <div>
              ...
              <p className="about-contain">
                We are committed to sustainability, utilizing materials from
                nature and energy materials and energy-efficient processes to
                minimize our environmental impact. Our focus is on providing
                durable, non-toxic solutions that promote healthier buildings
                and communities, contributing to a greener future.
              </p>
            </div>
          </div>
          <div className="about-main-img-container-2">
            <div className="about-img-5">
              <img
                src={`https://res.cloudinary.com/dcsentl2f/image/upload/w_400,h_300,c_scale,q_auto,f_auto/v1731404907/shreeInsul/intro%20of%20us%20image/tjsqi8tq2sio6hbpni4h.jpg`}
                alt=""
              />
            </div>
            <div>
              <div className="about-correct">
                <div className="icons-1">
                  ...
                  <p>
                    We focus on sustainability, using materials from nature and
                    energy processes to create durable, non-toxic solutions for
                ...
                <div className="icons-1 icons-2">
                  ...
                  <p>
                    With a commitment to customer satisfaction, we build lasting
                    partnerships through expertise, dedication, and impactful
                    practices.
                  </p>
                </div>
              </div>
